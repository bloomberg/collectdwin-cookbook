...
def default_write_http_nodes
    [
        'node' => {
            'attr' => {'name' => "testNode", 'url' => "http://localhost:8787/testhttp1", 'timeout' => 10000, 'batch_size' => 15, 'max_idle_time' => 700000}, 
...
def default_windows_performance_counters 
    [
        ...
        {'counter' => {'attr' => {'category' => "LogicalDisk", 'name' => "Free Megabytes", 'instance' => "*", 'scale_up_factor' => 1048576, 'collectd_plugin' => "df", 'collectd_plugin_instance' => "", 'collectd_type' => "df_complex",  'collectd_type_instance' => "free" } } },
